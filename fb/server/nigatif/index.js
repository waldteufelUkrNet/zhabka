...
/**
 * первинний ключ, під яким було здійснено запис в бд
 */
let id;

/**
 * момент часу, в який було здійснено запис в бд
 */
let time;
...
exports.handler = async (event, context, callback) => {
    ...
    try{
        ...
        callback(null, {status: "OK", error: null, data: {id, time}});
return;
...
var createFeedback = async (phone, text, type) => {
    ...
    time = moment().tz('Europe/Kiev').format('YYYY-MM-DD HH:mm:ss');
