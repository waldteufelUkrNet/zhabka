...
import {KeyboardBillsService, KeyboardPaymentDetailsService} from '../../shared';
...
@Component({
  ...
  providers: [KeyboardBillsService, KeyboardPaymentDetailsService]
})
export class BillComponent implements OnInit {
  ...
  constructor(
    private billsService: KeyboardBillsService,
  ...
  showShows(item){
    this.paymentDetailsService.getShowsList({payment_id:item.id, payment_type: 'business'})
    .then((mList: any) => {
      this.itemShows = mList;
    })
  }
  showSender(item){
    this.paymentDetailsService.getSender({payment_id:item.id, payment_type: 'business'})
    .then((mList: any) => {
